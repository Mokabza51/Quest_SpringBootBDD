package com.wildcodeschool.springHibernateQuest.utils;
...
import com.wildcodeschool.springHibernateQuest.entities.User;
import com.wildcodeschool.springHibernateQuest.repositories.UserDao;
@Component
public class Outputter implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = new User("Anna", "Wildeuse", 21);
        LOG.info("******************");
        ...
        User user2 = new User("Tony", "Wilder", 27);
        LOG.info("******************");
